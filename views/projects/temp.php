...
<div id ="all">
    <div id = "result">
        ...
        <div id="p2" class="part">
            <div id = "info">
                IR = &tau;<sub>IR</sub> – oznacza część promieniowania podczerwonego, która nie jest pochłaniane przez gazy atmosfery <br>
            </div>
            <div id = "tmperature">
        ...
        <div id="p3"class="part">
            <div id = "info">
                Vis = &tau;<sub>Vis</sub> – oznacza część otrzymywanej energii, która nie jest pochłaniana przez atmosferę. <br>
            </div>
        </div> 
