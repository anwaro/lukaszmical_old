...
<div id="puzzles">
    ...
    <div id="sample" class="container">
        <div class="row">
            <div class="sampleImg">
                <a  class="image featured" onclick="newGame('SAM', 1);"><img src="{%url%}/public/images/projects/puzzle/image1.jpg" alt="" /></a>
            </div>
            <div class="sampleImg">
                <a  class="image featured" onclick="newGame('SAM', 2);"><img src="{%url%}/public/images/projects/puzzle/image2.jpg" alt="" /></a>
            </div>
            <div class="sampleImg">
                <a  class="image featured" onclick="newGame('SAM', 3);"><img src="{%url%}/public/images/projects/puzzle/image3.jpg" alt="" /></a>
            </div>
            <div class="sampleImg">
                <a  class="image featured" onclick="newGame('SAM', 4);"><img src="{%url%}/public/images/projects/puzzle/image4.jpg" alt="" /></a>
            </div>
            <div class="sampleImg">
                <a  class="image featured" onclick="newGame('SAM', 5);"><img src="{%url%}/public/images/projects/puzzle/image5.jpg" alt="" /></a>
            </div>
        </div>
    </div>
    <div id="puzzleArea">
