...
<div class = "options">
    ...
    <div class = "opt" id="progButton">
        ...
        <div id="prog" class="addOpt">
            <table>
                <tr><td><input type="radio" name="prog" value="1">czarny i odcieńe szarości</td></tr>
                <tr><td><input type="radio" name="prog" value="0" checked>czarny i biały</td></tr>
                <tr><td><input type="radio" name="prog" value="-1">odcienie szarości i biały</td></tr>
                <tr>
    ...
    <div class = "opt" id="accent">
        ...
        <div id="pickColor" class="addOpt">				
            <table>
                <tr>
                    <td><canvas id="colorPicker"></canvas></td>
                </tr>
                <tr>
